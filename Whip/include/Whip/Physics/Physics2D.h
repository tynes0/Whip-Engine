...
public:
	...
	static void UpdateBoxCollider(const BoxCollider2DComponent& bc2d, const TransformComponent& transform, b2BodyId body);
	static void UpdateCircleCollider(const CircleCollider2DComponent& cc2d, const TransformComponent& transform, b2BodyId body);
