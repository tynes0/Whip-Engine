...
#define WHP_TUPLE_COMPARISON_OPERATOR_1(type, member, op)                      \
    ...
    #elif _MSC_VER
        #define WHP_HAS_NO_UNIQUE_ADDRESS 0 // no_unique_address is not available (C++17)
        #define WHP_NO_UNIQUE_ADDRESS
    #elif __cplusplus > 201703L && (_WHP_HAS_CPP_ATTRIBUTE(no_unique_address))
        #define WHP_HAS_NO_UNIQUE_ADDRESS 1
        #define WHP_NO_UNIQUE_ADDRESS [[no_unique_address]]
    #else
        #define WHP_HAS_NO_UNIQUE_ADDRESS 0 // no_unique_address is not available.
        #define WHP_NO_UNIQUE_ADDRESS
    #endif
#endif
...
WHP_FORCE_INLINE constexpr auto operator+(type_list<Ls...>, type_list<Rs...>)
{
...
{
    template <class T, class U>
    WHP_FORCE_INLINE constexpr bool _partial_cmp(T const& a, U const& b, bool& less) 
    {
    ...
    WHP_FORCE_INLINE constexpr bool _equals(Tup const& t1, Tup const& t2, type_list<B1...>) 
    {
#ifdef _MSC_VER
        return [&](auto&... v1) -> bool 
        {
    ...
    template <class Tup, class... B1>
    WHP_FORCE_INLINE constexpr bool _less(Tup const& t1, Tup const& t2, type_list<B1...>) 
    {
        bool is_less = false;
#ifdef _MSC_VER
        [&](auto&... v1) -> bool 
    ...
    template <class Tup, class... B1>
    WHP_FORCE_INLINE constexpr bool _less_eq(Tup const& t1, Tup const& t2, type_list<B1...>)
    {
        bool is_less = false;
#ifdef _MSC_VER
    ...
    WHP_FORCE_INLINE constexpr bool _equals(Tup1 const& t1, Tup2 const& t2, type_list<B1...>, type_list<B2...>) 
    {
#ifdef _MSC_VER
        return [&](auto&... v1) -> bool 
        {
    ...
    template <class Tup1, class Tup2, class... B1, class... B2>
    WHP_FORCE_INLINE constexpr bool _less(Tup1 const& t1, Tup2 const& t2, type_list<B1...>, type_list<B2...>) 
    {
        bool is_less = false;
#ifdef _MSC_VER
        [&](auto&... v1) -> bool 
    ...
    template <class Tup1, class Tup2, class... B1, class... B2>
    WHP_FORCE_INLINE constexpr bool _less_eq(Tup1 const& t1, Tup2 const& t2, type_list<B1...>, type_list<B2...>) 
    {
        bool is_less = false;
#ifdef _MSC_VER
        bool is_eq = [&](auto&... v1) -> bool 
...
#if WHP_DEFAULTED_COMPARISON
    WHP_FORCE_INLINE auto operator<=>(type_map const&) const = default;
    WHP_FORCE_INLINE bool operator==(type_map const&) const = default;
#else
    WHP_FORCE_INLINE constexpr auto operator==(type_map const& other) const 
    {
...
struct tuple_elem 
{
    ...
    WHP_FORCE_INLINE constexpr decltype(auto) operator[](tag<I>)& 
    {
        return (value);
    }
    WHP_FORCE_INLINE constexpr decltype(auto) operator[](tag<I>) const& 
    {
        return (value);
    }
    WHP_FORCE_INLINE constexpr decltype(auto) operator[](tag<I>)&& 
...
#if WHP_DEFAULTED_COMPARISON
    WHP_FORCE_INLINE auto operator<=>(tuple_elem const&) const = default;
    WHP_FORCE_INLINE bool operator==(tuple_elem const&) const = default;
    WHP_FORCE_INLINE constexpr auto operator<=>(tuple_elem const& other) const noexcept(noexcept(value <=> other.value)) requires(std::is_reference_v<T>&& ordered<T>)
    {
        return value <=> other.value;
    }
    WHP_FORCE_INLINE constexpr bool operator==(tuple_elem const& other) const noexcept(noexcept(value == other.value)) requires(std::is_reference_v<T>&& equality_comparable<T>)
    {
        return value == other.value;
    }
#else
...
namespace detail_tuple 
{
    ...
    WHP_FORCE_INLINE constexpr void _for_each(Tup&& tup, F&& func, type_list<B...>) 
    {
        (void(func(WHP_FWD_M(Tup, B, tup, value))), ...);
    }

    template <class Tup, class F, class... B>
    WHP_FORCE_INLINE constexpr bool _any(Tup&& tup, F&& func, type_list<B...>) 
    {
#ifdef _MSC_VER
        return [&](auto&&... v1) -> bool 
        {
    ...
    template <class Tup, class F, class... B>
    WHP_FORCE_INLINE constexpr bool _all(Tup&& tup, F&& func, type_list<B...>) {
#ifdef _MSC_VER
        return [&](auto&&... v1) -> bool 
        {
            return (bool(func(static_cast<decltype(v1)&&>(v1))) && ...);
    ...
    template <class Tup, class F, class... B>
    WHP_FORCE_INLINE constexpr auto _map(Tup&& tup, F&& func, type_list<B...>)-> tuple<decltype(func(WHP_FWD_M(Tup, B, tup, value)))...> 
    {
        return { func(WHP_FWD_M(Tup, B, tup, value))... };
    }

    template <class Tup, class F, class... B>
    WHP_FORCE_INLINE constexpr decltype(auto) _apply(Tup&& t, F&& f, type_list<B...>) 
    {
        return static_cast<F&&>(f)(WHP_FWD_M(Tup, B, t, value)...);
    }

    template <class U, class Tup, class... B>
    WHP_FORCE_INLINE constexpr U _convert(Tup&& t, type_list<B...>) 
    {
...
struct tuple : tuple_base_t<T...> 
{
...
#if _MSC_VER
        nothrow_swappable = ::whip::detail_tuple::extra_detail::_all_true<is_nothrow_swappable_v<T>...>();
#else
    ...
    WHP_FORCE_INLINE constexpr auto& operator=(U&& tup) 
    {
...
#if WHP_DEFAULTED_COMPARISON
    WHP_FORCE_INLINE auto operator<=>(tuple const&) const = default;
    WHP_FORCE_INLINE bool operator==(tuple const&) const = default;
    WHP_FORCE_INLINE bool operator!=(tuple const&) const = default;
    WHP_FORCE_INLINE bool operator<(tuple const&) const = default;
    WHP_FORCE_INLINE bool operator>(tuple const&) const = default;
    WHP_FORCE_INLINE bool operator<=(tuple const&) const = default;
    WHP_FORCE_INLINE bool operator>=(tuple const&) const = default;
#else
    WHP_FORCE_INLINE constexpr auto operator==(tuple const& other) const 
    {
...
#endif
    template <class... U>
    WHP_FORCE_INLINE constexpr auto operator==(tuple<U...> const& other) const -> WHP_TYPES_EQ_WITH(T, U) 
    {
    ...
    template <class... U>
    WHP_FORCE_INLINE constexpr auto operator<(tuple<U...> const& other) const -> WHP_TYPES_CMP_WITH(T, U) 
    {
        using other_base_list = typename tuple<U...>::base_list;
    ...
    WHP_FORCE_INLINE constexpr void swap(tuple& other) noexcept(nothrow_swappable) 
    {
        _swap(other, base_list{});
    }

    template <class F>
    WHP_FORCE_INLINE constexpr void for_each(F&& func) & 
    {
        detail_tuple::_for_each(*this, static_cast<F&&>(func), base_list{});
    }

    template <class F>
    WHP_FORCE_INLINE constexpr void for_each(F&& func) const& 
    {
        detail_tuple::_for_each(*this, static_cast<F&&>(func), base_list{});
    }
    ...
    template <class F>
    WHP_FORCE_INLINE constexpr bool any(F&& func) & 
    {
        return detail_tuple::_any(*this, static_cast<F&&>(func), base_list{});
    }

    template <class F>
    WHP_FORCE_INLINE constexpr bool any(F&& func) const& 
    {
        return detail_tuple::_any(*this, static_cast<F&&>(func), base_list{});
    }
    ...
    template <class F>
    WHP_FORCE_INLINE constexpr bool all(F&& func) &
    {
        return detail_tuple::_all(*this, static_cast<F&&>(func), base_list{});
    }

    template <class F>
    WHP_FORCE_INLINE constexpr bool all(F&& func) const& 
    {
        return detail_tuple::_all(*this, static_cast<F&&>(func), base_list{});
    }
    ...
    template <class F>
    WHP_FORCE_INLINE constexpr auto map(F&& func)&
    {
        return detail_tuple::_map(*this, static_cast<F&&>(func), base_list{});
    }
    template <class F>
    WHP_FORCE_INLINE constexpr auto map(F&& func) const& 
    {
        return detail_tuple::_map(*this, static_cast<F&&>(func), base_list{});
    }
    template <class F>
    ...
    template <class F>
    WHP_FORCE_INLINE constexpr decltype(auto) apply(F&& func) & 
    {
        return detail_tuple::_apply(*this, static_cast<F&&>(func), base_list{});
    }
    template <class F>
    WHP_FORCE_INLINE constexpr decltype(auto) apply(F&& func) const& 
    {
        return detail_tuple::_apply(*this, static_cast<F&&>(func), base_list{});
    }
    template <class F>
    ...
    template <class U>
    WHP_FORCE_INLINE constexpr U as()& 
    {
        return detail_tuple::_convert<U>(*this, base_list{});
    }

    template <class U>
    WHP_FORCE_INLINE constexpr U as() const& 
    {
        return detail_tuple::_convert<U>(*this, base_list{});
    }
...
private:
    template <class... B>
    WHP_FORCE_INLINE constexpr void _swap(tuple& other, type_list<B...>) noexcept(nothrow_swappable) 
    {
        (whip::swap(B::value, WHP_GET_M(B, other, value)), ...);
    }

    template <class U, class... B1, class... B2>
    WHP_FORCE_INLINE constexpr void _assign_tup(U&& u, type_list<B1...>, type_list<B2...>) 
    {
    ...
    WHP_FORCE_INLINE constexpr void _assign_index_tup(U&& u, std::index_sequence<I...>) 
    {
        // todo: make this whip
        using std::get;
    ...
    WHP_FORCE_INLINE constexpr void _assign(type_list<B...>, U&&... u) 
    {
...
WHP_FORCE_INLINE constexpr decltype(auto) get(Tup&& tup) 
{
    return static_cast<Tup&&>(tup)[tag<I>()];
}

template <class... T>
WHP_FORCE_INLINE constexpr tuple<T&...> tie(T&... t) 
{
    return { t... };
}

template <class F, WHP_WEAK_CONCEPT(base_list_tuple) Tup>
WHP_FORCE_INLINE constexpr decltype(auto) apply(F&& func, Tup&& tup) 
{
    return detail_tuple::_apply(static_cast<Tup&&>(tup), static_cast<F&&>(func), typename std::decay_t<Tup>::base_list{});
}

template <class... T>
WHP_FORCE_INLINE void swap(tuple<T...>& a, tuple<T...>& b) noexcept(tuple<T...>::nothrow_swappable) 
{
    a.swap(b);
}

template <typename... Ts>
WHP_FORCE_INLINE constexpr auto make_tuple(Ts&&... args) 
{
    return tuple<unwrap_ref_decay_t<Ts>...> {static_cast<Ts&&>(args)...};
}

template <typename... T>
WHP_FORCE_INLINE constexpr auto forward_as_tuple(T&&... a) noexcept 
{
...
namespace detail_tuple
{
    ...
    WHP_FORCE_INLINE constexpr auto _repeat_type(type_list<Q...>) 
    {
        return type_list<first_t<T, Q>...> {};
    }
    template <class... Outer>
    WHP_FORCE_INLINE constexpr auto _get_outer_bases(type_list<Outer...>)
    {
        return (_repeat_type<Outer>(base_list_t<type_t<Outer>> {}) + ...);
    }
    template <class... Outer>
    WHP_FORCE_INLINE constexpr auto _get_inner_bases(type_list<Outer...>) 
    {
        return (base_list_t<type_t<Outer>> {} + ...);
    }

    template <class T, class... Outer, class... Inner>
    WHP_FORCE_INLINE constexpr auto _tuple_cat(T tup, type_list<Outer...>, type_list<Inner...>) -> tuple<type_t<Inner>...> 
    {
